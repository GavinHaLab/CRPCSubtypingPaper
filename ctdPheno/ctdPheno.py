...
def main():
    ...
    if test_data == 'patient_WGS':
        ...
        df_patient = df_patient[df_patient.index.str.contains('_35CR_')]
        ...
        df_patient = df_patient[~df_patient.index.str.contains('22667S')]
        df_patient = df_patient[~df_patient.index.str.contains('23552H')]
        df_patient = df_patient[~df_patient.index.str.contains('23736S')]
    ...
    for feature in features:
        ...
        if 'patient' or 'crpc' or 'beltran' or 'emseq' in test_data:
        ...
        elif 'triplet' in test_data:
            beta_descent(metric_dict, df_patient, ['ARPC', 'NEPC'], name, eval='TripletBox', base_df=df_diff)
        else:  # benchmarking
